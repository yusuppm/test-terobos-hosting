...
<section id="perangkat" class="bg-gray-50 py-16 sm:py-20 pt-28">
  <div class="container mx-auto px-4">
    ...
    <div class="text-center mb-12 sm:mb-16" data-aos="fade-up">
        ...
        <h2 class="text-3xl sm:text-4xl md:text-5xl font-bold text-[#002343] mt-4">
            Katalog <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#0157B2] to-[#01C0DB]">Perangkat</span> Kami
        </h2>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      </div> <div class="bg-white border border-gray-100 rounded-2xl shadow-lg overflow-hidden flex flex-col transition-all duration-300 transform hover:scale-105" data-aos="fade-up" data-aos-delay="300">
      ...
      </div> <div class="bg-white border border-gray-100 rounded-2xl shadow-lg overflow-hidden flex flex-col transition-all duration-300 transform hover:scale-105" data-aos="fade-up" data-aos-delay="400">
        <img src="{{ asset('storage/perangkat_photos/ldr_sensor.png') }}" alt="Sensor cahaya LDR" class="h-56 w-full object-cover">
        <div class="p-5 flex flex-col flex-grow">
          <h3 class="text-lg font-bold text-[#002343] mb-2">Sensor cahaya LDR</h3>
          <ul class="list-disc list-inside text-gray-600 text-sm space-y-1 mb-4">
      ...
      </div> </div> <div class="space-y-8 mt-12" data-aos="fade-up" data-aos-delay="500"> 
        ...
        <div class="flex items-start space-x-4">
            ...
            <div>
                ...
                <ul class="list-disc list-inside space-y-2 text-base text-gray-700">
                  <li>ROSUS membuka ruang bagi pengguna untuk menjual/membeli kerangka & komponen.</li>
      ...
      </div> <div class="bg-gradient-to-r from-green-50 to-green-100 p-6 md:p-8 rounded-2xl shadow-lg border border-green-100">
        <div class="flex items-start space-x-4">
                ...
                <div class="space-y-4 text-base text-gray-700">
                  ...
                  <div>
                    ...
                    <ul class="list-disc list-inside ml-4 space-y-1">
                      <li>ROSUS mengumpulkan perangkat elektronik tidak terpakai dari komunitas & mitra.</li>
